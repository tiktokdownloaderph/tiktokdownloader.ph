...
export default function TermsPage() {
  return (
    <main className="site-info-page site-info-page--legal">
      <div className="container" style={{ paddingTop: 36, paddingBottom: 56 }}>
        <div className="row justify-content-center">
          <div className="col-12 col-lg-8">
            ...
            <p style={{ color: "rgba(255,255,255,0.38)", fontSize: ".8rem", marginBottom: 28 }}>Terms and Conditions &mdash; Huling na-update: Setyembre 23, 2026</p>
